...
/*
 * argusmodule - add descriptor labels to flows.
 ...
 * QoSient, LLC
 *
 * $Id: //depot/gargoyle/clients/examples/argusmodule/argusmodule.c#17 $
...
{
   extern char version[];
   fprintf (stdout, "ArgusModule Version %s\n", version);
   ...
   fprintf (stdout, "options: -f <conffile>     read argusmodule spec from <conffile>.\n");
   fflush (stdout);
   exit(1);
}
