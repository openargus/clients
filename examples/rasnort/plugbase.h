...
/* $Id: plugbase.h,v 1.2 2004/05/14 15:44:35 qosient Exp $ */
...
/*
OptFpList *AddOptFuncToList(int (*func)(struct ArgusRecord *, struct _OptTreeNode *, struct _OptFpList *), OptTreeNode *);
*/

void AddRspFuncToList(int (*func) (struct ArgusRecord *, struct _RspFpList *), OptTreeNode *, void *);
...
void AddFuncToPreprocList(void (*func)(struct ArgusRecord *));
