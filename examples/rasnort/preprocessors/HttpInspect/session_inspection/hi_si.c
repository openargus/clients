        ...
        HI_SESSION **Session, HI_SI_INPUT *SiInput, int *piInspectMode)
{
    ...
    if((iRet = InitServerConf(GlobalConf, &ServerConf, &ClientConf, SiInput, 
                    piInspectMode)))
    {
        return iRet;
    }
        ...
        HI_SESSION **Session, HI_SI_INPUT *SiInput, int *piInspectMode)
{
    ...
    */
    ...
    {
        if((iRet = StatefulSessionInspection(GlobalConf, Session, SiInput, 
                        piInspectMode)))
        {
            return iRet;
        }
    ...
    else
    {
        ...
        */
        if((iRet = StatelessSessionInspection(GlobalConf, Session, SiInput, 
                        piInspectMode)))
        {
            return iRet;
        }
